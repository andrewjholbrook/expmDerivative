...
\begin{align}\label{eq:phyloGrad}
	\frac{\partial}{\partial \theta_d}  p(\y|\ttheta)  &=   \sum_{v=1}^{2N-2} \mbox{tr} \left( \frac{\partial p(\y|\ttheta)}{\partial \P_v} \frac{\partial \P_v}{\partial \theta_d} \right) = \sum_{v=1}^{2N-2} \mbox{tr} \left( \frac{\partial p(\y|\ttheta)}{\partial \P_v} \frac{\partial e^{\gamma t_v \QQ}}{\partial \theta_d} \right)  \\
	&=\sum_{v=1}^{2N-2} \mbox{tr} \left( \frac{\partial p(\y|\ttheta)}{\partial \P_v} \sum_{s=1}^S \sum_{s'=1}^S \frac{\partial e^{\gamma t_v \QQ}}{\partial q_{ss'}} \frac{\partial q_{ss'}}{\partial \theta_d} \right)  \, .
\end{align}
