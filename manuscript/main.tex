...
\begin{align}\label{eq:phyloGrad}
	...
	= \sum_{v=1}^{2N-2} \mbox{tr} \left(  (\q_u\circ \P_w\p_w) \p_v^T \frac{\partial e^{\gamma t_v \QQ^T}}{\partial \theta_d}\right)  \\ \nonumber
	&=\sum_{v=1}^{2N-2} \p_v^T \left(\sum_{s=1}^S \sum_{s'=1}^S \frac{\partial e^{\gamma t_v \QQ^T}}{\partial q_{ss'}} \frac{\partial q_{ss'}}{\partial \theta_d} \right) (\q_u\circ \P_w\p_w)  \, .
\end{align}
