...
\begin{itemize}
	\item clarified how the present work relates to our other work that includes thorough simulation studies \citep{magee2023random} and provides strong theoretical guarantees for surrogate-trajectory HMC \citep{glatt2020accept};
	
	\item implemented two additional simulation studies which compare posteriors obtained for multiple algorithms and illustrate parameter identification  for different model sizes and different sparsity regimes;
...
\begin{reply}
	Thank you for the opportunity to submit a revised manuscript. We have made ample additions to the manuscript in response to the helpful suggestions made by both reviewers. Among the many improvements we have made to this manuscript, the simulation studies suggested by Reviewer 2 help the paper smoothly transition between theory and application.
\end{reply}
...
In short, our original goal was not to prove validity of surrogate-trajectory HMC, which we saw as already established through simulation studies, real-world analyses and measure theoretic arguments.   
