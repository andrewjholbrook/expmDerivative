...
\begin{reply}
	We thank you for sharing these concerns.  Before responding, let us point out that we have now added a simulation section (similar to that which you specify below) to the manuscript.   Now, we would like to argue that the decisions we made in structuring our manuscript are well-motivated based on our work in two other papers.
	\begin{enumerate}
		\item First,
	\end{enumerate}
\end{reply}
