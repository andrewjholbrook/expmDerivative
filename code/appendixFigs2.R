...
gg <- ggplot(df,aes(x=t,y=Error,color=Dimension)) +
  geom_smooth(size=1.5,se=FALSE) + ylab("Approx. error (Frobenius norm)") +
...
ggsave(ggpubr::ggarrange(gg,NULL,gg2,NULL,gg3,nrow = 1,
       ...
       width = 12,height = 4,
       file="figures/appendixFig2.pdf")
system2(command = "pdfcrop",
        args    = c("~/expmDerivative/figures/appendixFig2.pdf",
                    "~/expmDerivative/figures/appendixFig2.pdf")
)
